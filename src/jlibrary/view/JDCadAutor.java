 ...
 * @author Natanael
 */
public class JDCadAutor extends javax.swing.JDialog {

    public JDCadAutor(java.awt.Window parent) {
    ...
    private void initComponents() {
        ...
        jBCadastrar.setNextFocusableComponent(jBCancelar);
    ...
    private void jBCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBCadastrarActionPerformed
        ...
        try {
            ...
            if (!autorDao.existe(nome)) {
                ...
                int r = JOptionPane.showConfirmDialog(this, "Autor cadastrado com sucesso \n Deseja cadastrar outro autor?",
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDCadAutor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDCadAutor dialog = new JDCadAutor(new javax.swing.JFrame());
