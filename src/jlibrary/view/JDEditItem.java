...
import jlibrary.persistencia.AutorItemDao;
 ...
 * @author Natanael
 */
public class JDEditItem extends javax.swing.JDialog {
    ...
    public JDEditItem(java.awt.Window parent, Item item) {
    ...
    private void initComponents() {
        ...
        jBConfirmar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/jlibrary/icons/pack1/102.png"))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jTabMain, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
    ...
    private void jTRemAutorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTRemAutorActionPerformed
        ...
        if (jTbAutores.getSelectedRow() > -1) {
            int idAutor = listaAutor.get(jTbAutores.getSelectedRow()).getIdAutor();
            for (Integer i : listaIdAutor) {
                if (idAutor == i) {
                    listaIdAutor.remove(i);
                    break;
                }
            }
            ...
            if (jTbAutores.getRowCount() > 0) {
                ...
                JOptionPane.showMessageDialog(null, "A tabela já está vazia",
                        "Nenhum item selecionado", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    private void jBConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBConfirmarActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Não foi possível atualizar este item no sistema\nErro:" + ex.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
        }
    ...
    private void preencheLacunas() {
        jTTitulo.setText(item.getTitulo());
        jTSubTitulo.setText(item.getSubtitulo());
        jCBIdioma.setSelectedItem(item.getIdioma());
        jTCodigo.setText(item.getCodigo());
        jTISBN.setText(item.getIsbn());
        jTLocal.setText(item.getLocal());
        jTExemplar.setText(item.getExemplar());
        jTVolume.setText(item.getVolume());
        jTEdicao.setText(item.getEdicao());
        jTAno.setText(String.valueOf(item.getAno()));
        jTNumPags.setText(String.valueOf(item.getNumPags()));
    }

    private void preencheAutores() {
        AutorItemDao aiDao = new AutorItemDao();
        try {
            listaAutor = aiDao.select(item.getIdItem());

            DefaultTableModel modelo = (DefaultTableModel) jTbAutores.getModel();
            modelo.setRowCount(0);
            for (Autor autor : listaAutor) {
                modelo.addRow(new Object[]{autor.getNome()});
                listaIdAutor.add(autor.getIdAutor());
            }
        } catch (SQLException ex) {
            Logger.getLogger(JDEditItem.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
            ...
            case 1:
                ...
                try {
                    ...
                    for (ClassifLit classiflit : listaClassif) {
                        ...
                        if (classiflit.getIdClassLit() == item.getIdClassLit()) {
                            jCBClassificacao.setSelectedIndex(jCBClassificacao.getItemCount() - 1);
                        }
                    }
            ...
            case 2:
                ...
                try {
                    ...
                    for (Editora editora : listaEditora) {
                        ...
                        if (editora.getIdEditora() == item.getIdEditora()) {
                            jCBEditora.setSelectedIndex(jCBEditora.getItemCount() - 1);
                        }
                    }
                } catch (SQLException e) {
                    JOptionPane.showMessageDialog(null, "Erro: \n" + e.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
            ...
            case 3:
                ...
                try {
                    ...
                    for (TipoItem tipoItem : listaTipoItem) {
                        ...
                        if (tipoItem.getIdTipo() == item.getIdTipo()) {
                            jCBTipoItem.setSelectedIndex(jCBTipoItem.getItemCount() - 1);
                        }
                    }
                } catch (SQLException ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDEditItem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDEditItem dialog = new JDEditItem(new javax.swing.JDialog(), null);
