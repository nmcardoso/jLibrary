 ...
 * @author Natanael
 */
public class JDEditTipoItem extends javax.swing.JDialog {

    private TipoItem tipoItem;
    
    public JDEditTipoItem(java.awt.Window parent) {
    ...
    private void initComponents() {
        ...
        setTitle("Editar tipo de item");

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 20)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("EDITAR TIPO DE ITEM");
        ...
        jLTipo.setText("<html>Nome antigo: <font color=\"#FF0000\">NOME</font></html>");
    ...
    private void jBCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBCadastrarActionPerformed
        ...
        tipoItem.setTipo(nome);

        try {
            TipoItemDao tipoItemDao = new TipoItemDao();

            if (!tipoItemDao.existe(nome)) {
                tipoItemDao.update(tipoItem);
                this.dispose();
            } else {
                JOptionPane.showMessageDialog(null, "Este tipoItem já está cadastrado no sistema"
                        + "\n" + "TipoItem: " + nome, "Erro: O tipoItem já existe", JOptionPane.ERROR_MESSAGE);
            }
    ...
    public void show(TipoItem tipoItem){
        this.tipoItem = tipoItem;
        jLTipo.setText("<html>Tipo de item antigo: <font color='#FF0000'>"+tipoItem.getTipo()+"</font></html>");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDEditTipoItem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDEditTipoItem dialog = new JDEditTipoItem(new javax.swing.JFrame());
