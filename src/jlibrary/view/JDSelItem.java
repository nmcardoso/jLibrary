 ...
 * @author Natanael
 */
public class JDSelItem extends javax.swing.JDialog {

    private List<Item> listaItem;
    private String dados[] = new String[2];
    private boolean disponivel;
    
    public JDSelItem(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jBOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBOkActionPerformed
        ...
        dados[0] = String.valueOf(listaItem.get(jTbResultado.getSelectedRow()).getIdItem());
        dados[1] = listaItem.get(jTbResultado.getSelectedRow()).getTitulo();
        this.dispose();
    ...
    public String[] showDialog(boolean disponivel) {
    ...
    private void preencheTabela() {
        ...
        try {
            if (disponivel) {
                listaItem = itemDao.selectDisponivel(jTBusca.getText());
            }else{
                listaItem = itemDao.select(jTBusca.getText());
            }
            DefaultTableModel modelo = (DefaultTableModel) jTbResultado.getModel();
            modelo.setRowCount(0);

            for (Item item : listaItem) {
                modelo.addRow(new Object[]{item.getTitulo(),item.getExemplar()});
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDSelItem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDSelItem dialog = new JDSelItem(new javax.swing.JDialog(), true);
