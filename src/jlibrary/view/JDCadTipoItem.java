 ...
 * @author Natanael
 */
public class JDCadTipoItem extends javax.swing.JDialog {

    public JDCadTipoItem(java.awt.Window parent) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CADASTRAR TIPO DE ITEM");
    ...
    private void jBCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBCadastrarActionPerformed
        String tipo = new FormatarTexto().formatar(jTTipo);
        ...
        try {
            ...
            if (!tipoItemDao.existe(tipo)) {
                tipoItemDao.insert(tipoItem);
                
                int r = JOptionPane.showConfirmDialog(this, "Tipo de item cadastrado com sucesso \n Deseja cadastrar outro tipo de item?",
                        "Cadastrado com sucesso", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE);
                if (r == JOptionPane.NO_OPTION) {
                    this.dispose();
                }
            } else {
                JOptionPane.showMessageDialog(null, "Este tipo de item já está cadastrado no sistema"
                        + "\n" + "Tipo de Item: " + tipo, "Erro: O tipo de item já existe", JOptionPane.ERROR_MESSAGE);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDCadTipoItem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDCadTipoItem dialog = new JDCadTipoItem(new javax.swing.JFrame());
