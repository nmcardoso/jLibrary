 ...
 * @author Natanael
 */
public class JDEditAutor extends javax.swing.JDialog {

    private Autor autor;
    
    public JDEditAutor(java.awt.Window parent) {
    ...
    private void initComponents() {
        ...
        jLNome.setText("<html>Nome antigo: <font color=\"#FF0000\">NOME</font></html>");
    ...
    public void show(Autor autor){
        this.autor = autor;
        jLNome.setText("<html>Nome antigo: <font color='#FF0000'>"+autor.getNome()+"</font></html>");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDEditAutor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDEditAutor dialog = new JDEditAutor(new javax.swing.JFrame());
