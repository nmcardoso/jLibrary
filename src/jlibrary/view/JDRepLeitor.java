 ...
 * @author Natanael
 */
public class JDRepLeitor extends javax.swing.JDialog {

    private String[] leitor;

    public JDRepLeitor(java.awt.Window parent) {
    ...
    private void initComponents() {
        ...
        setTitle("Relatório do Leitor");
        setResizable(false);

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("RELATÓRIOS DO LEITOR");
        ...
        jLabel4.setText("<html>\nEste assistente de geração de relatórios te auxiliará a criar um relatório relacionado<br />\naos leitores da biblioteca. Você poderá gerar um relatório de um leitor específico<br />\nou de vários leitores. Para isso, selecione uma das opções seguintes.\n</html>");
        ...
        jLabel1.setText("<html>\nNesta opção, é gerado um relatório com os leitores cadastrados<br />\nno sistema em um determinado período de tempo.\n</html>");
        ...
        jLabel5.setText("Gerar relatório de um leitor específico");

        jLabel6.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel6.setText("<html> Aqui é gerado um relatório detalhado com todas as informações<br /> de um determinado leitor cadastrado. </html>");

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/jlibrary/images/user64.png"))); // NOI18N
        ...
        jLabel12.setText("Selecione um leitor através do botão pesquisar para gerar o relatório detalhado");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (data1.before(data2) || data1.equals(data2)) {
            InputStream inputStream = getClass().getResourceAsStream("/jlibrary/reports/LeitorPorData.jasper");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        InputStream inputStream = getClass().getResourceAsStream("/jlibrary/reports/LeitorPorId.jasper");

        // mapa de parâmetros do relatório
        Map parametros = new HashMap();
        parametros.put("ID", Integer.parseInt(leitor[0]));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDRepLeitor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDRepLeitor dialog = new JDRepLeitor(new javax.swing.JFrame());
