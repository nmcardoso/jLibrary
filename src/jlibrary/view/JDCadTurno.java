 ...
 * @author Natanael
 */
public class JDCadTurno extends javax.swing.JDialog {

    public JDCadTurno(java.awt.Window parent) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CADASTRAR TURNO");
        ...
        jTTurno.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jTTurnoKeyPressed(evt);
            }
        });
    ...
    private void jBCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBCadastrarActionPerformed
        String txt = new FormatarTexto().formatar(jTTurno);
        ...
        try {
            ...
            if (!turnoDao.existe(txt)) {
                turnoDao.insert(turno);
                
                int r = JOptionPane.showConfirmDialog(this, "Turno cadastrado com sucesso \n Deseja cadastrar outro turno?",
    ...
    private void jTTurnoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTTurnoKeyPressed
        if (evt.getKeyCode() == evt.VK_ENTER) {
            jBCadastrarActionPerformed(null);
            jTTurno.setText("");
        }
    }//GEN-LAST:event_jTTurnoKeyPressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDCadTurno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDCadTurno dialog = new JDCadTurno(new javax.swing.JFrame());
