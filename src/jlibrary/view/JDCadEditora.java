 ...
 * @author Natanael
 */
public class JDCadEditora extends javax.swing.JDialog {

    public JDCadEditora(java.awt.Window parent) {
    ...
    private void jBCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBCadastrarActionPerformed
        ...
        try {
            ...
            if (!editoraDao.existe(nome)) {
                ...
                int r = JOptionPane.showConfirmDialog(this, "Editora cadastrada com sucesso \n Deseja cadastrar outra editora?",
                ...
                JOptionPane.showMessageDialog(null, "Esta editora já está cadastrada no sistema"
                        + "\n" + "Editora: " + nome, "Erro: A editora já existe", JOptionPane.ERROR_MESSAGE);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDCadEditora.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDCadEditora dialog = new JDCadEditora(new javax.swing.JFrame());
